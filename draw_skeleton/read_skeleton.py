...
def read_skeleton():
    ...
    if args.subject_ID:  # to include the information about the subject.
        ...
        skeleton_data = utils.care_subject(
            num_of_frames, read_lines
        )  # read the information from the list

    else:

        skeleton_data = utils.no_subject(
            num_of_frames, read_lines
        )  # read the information from the list
    ...
    # write the skeleton data to a file
    # utils.write_skeleton(skeleton_data)
    print(skeleton_data)
